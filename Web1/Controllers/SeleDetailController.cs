...
namespace Web.Controllers
{
    ...
    public class SeleDetailController : ControllerBase
    {
        private readonly SeleDetailBusiness _SeleDetailBusiness;
        private readonly ILogger<SeleDetailController> _logger;
        ...
        public SeleDetailController(SeleDetailBusiness SeleDetailBusiness, ILogger<SeleDetailController> logger)
        {
        ...
        [HttpGet]
        [ProducesResponseType(typeof(IEnumerable<SeleDetailDto>), 200)]
        ...
        /// <response code="500">Error interno del servidor</response>
        [HttpGet("{id}")]
        [ProducesResponseType(typeof(SeleDetailDto), 200)]
        ...
        /// <response code="500">Error interno del servidor</response>
        [HttpPost]
        [ProducesResponseType(typeof(SeleDetailDto), 201)]
        [ProducesResponseType(400)]
        [ProducesResponseType(500)]
        public async Task<IActionResult> CreateSeleDetail([FromBody] SeleDetailDto seleDetailDto)
        {
            try
            {
