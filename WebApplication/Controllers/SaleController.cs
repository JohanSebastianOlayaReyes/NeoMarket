...
namespace Web.Controllers
{
    ...
    {
        private readonly SaleBusiness _SeleBusiness;
        ...
        public SaleController(SaleBusiness SeleBusiness, ILogger<SaleController> logger)
        {
        ...
        [ProducesResponseType(400)]
        [ProducesResponseType(500)]
        public async Task<IActionResult> CreateSele([FromBody] SaleDTO seleDto)
        {
            try
            {
